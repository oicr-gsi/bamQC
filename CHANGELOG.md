...
## [5.3.7] - 2026-08-04
### Added
- added hg38_noAlt resources
### Changed
- changed parametrisation of windowedMosDepth so that it is better controlled in olives
...
## [5.3.3] - 2025-11-06
### Added
- alias bamqclite for clear distiction between bamqcl lite and original version

##  [5.3.2] - 2025-10-21
### Added
- previously omitted metadata fields in final report
### Changed
- duplicate read percentage are now reported as ratio (to make this metric back-compatible with picard-generated results)
- Switched to bam-qc-metrics/0.2.8
- [GRD-946](https://jira.oicr.on.ca/browse/GRD-946)

##  [5.3.1] - 2025-09-29
### Added
- tasks for handling coverage and duplicate marking data in call-ready mode
### Changed
- Switched to bam-qc-metrics/0.2.7
- simplified the workflow by removing extra parameters (mode, runBedtools)
- removed histogram-generating python code from wdl (now handled by bam-qc-metrics scripts)
- [GRD-946](https://jira.oicr.on.ca/browse/GRD-946) - still the same ticket, bamQC lite gets finalized
