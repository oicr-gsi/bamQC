...
`preFilter.modules`|String|"samtools/1.9"|required environment modules
`preFilter.jobMemory`|Int|16|Memory allocated for this job
...
`filterBamQC.minQuality`|Int|30|Minimum alignment quality to pass filter
`filterBamQC.modules`|String|"samtools/1.9"|required environment modules
`filterBamQC.jobMemory`|Int|16|Memory allocated for this job
`filterBamQC.threads`|Int|4|Requested CPU threads
`filterBamQC.timeout`|Int|4|hours before task timeout
